...
In Google Chrome Developer Tools I used the lighthouse element to check the performance of the site. As can be seen form the image, the performance of the site is excellent and it indicates that best practices hav ebeen used.
